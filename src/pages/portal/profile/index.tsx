...
import { usePortalTheme, usePortalWideLayout } from '@/pages/portal/use-portal-theme'
...
export default function PortalProfile() {
  usePortalTheme()
  const wideLayout = usePortalWideLayout()
  ...
  if (loading) {
    return (
      <div className="hero-profile space-y-6">
        <div>
  ...
  return (
    <>
      <div className="hero-profile space-y-6">
        ...
        <TabsPrimitive.Root data-slot="tabs" className="group/tabs flex gap-2 data-horizontal:flex-col" defaultValue="profile" orientation={wideLayout ? 'vertical' : 'horizontal'}>
