import { usePortalTheme } from '@/pages/portal/use-portal-theme'
...
export default function PortalLogin() {
  ...
  return (
    <div className="hero-auth min-h-screen flex flex-col items-center justify-center bg-background px-4">
