            ...
            {editingExpire ? (
              <div className="flex flex-wrap items-center gap-1.5 mt-0.5">
                <Input
                  ...
                  disabled={savingExpire}
                  className="h-7 text-sm w-52 max-w-full"
                />
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" className="size-6" aria-label="保存到期时间" onClick={() => saveExpire()} disabled={savingExpire || !expireValue}>
                ...
                {instance.expire_at && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="ghost" size="sm" className="h-6 px-2" onClick={() => saveExpire(true)} disabled={savingExpire}>
                        永不过期
                      </Button>
                    </TooltipTrigger>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" className="size-6" aria-label="取消修改到期时间" onClick={() => setEditingExpire(false)} disabled={savingExpire}>
                      <X className="size-3" />
                    </Button>
                  </TooltipTrigger>
              ...
              <div className="flex items-center gap-1 mt-0.5">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" className="size-5" aria-label="修改到期时间" onClick={() => {
